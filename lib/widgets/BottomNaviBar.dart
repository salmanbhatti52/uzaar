...
import '../screens/SellScreens/ProductSellScreens/SellScreen.dart';
                ...
                child: BottomNavigationBar(
                  ...
                  items: [
                    ...
                    BottomNavigationBarItem(
                      icon: SvgPicture.asset('assets/add_item_icon.svg'),
                      activeIcon:
                          SvgPicture.asset('assets/add_item_selected.svg'),
                      label: '',
                    ),
                    BottomNavigationBarItem(
                      icon: SvgPicture.asset('assets/list_item_icon.svg'),
                      activeIcon:
                          SvgPicture.asset('assets/list_item_selected.svg'),
                      label: '',
                    ),
                    BottomNavigationBarItem(
                      icon: SvgPicture.asset('assets/person-grey.svg'),
