                      ...
                      itemBuilder: (context, index) {
                        return ProductListTile(
                          ...
                          productImage: imgBaseUrl +
                              listedProducts[index]['listings_images'][0]
                                  ['image'],
                          ...
                          onSelected: (selectedValue) async {
                            ...
                            if (selectedOption == 'boost') {
                              if (listedProducts[index]['featured'] == 'No') {
                                showDialog(
                                  context: context,
                                  builder: (
                                    context,
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (context) =>
                                                                  PaymentScreen(
                                                                    ...
                                                                    selectedPackage:
                                                                        selectedPackage,
                                                                    userCustomerPackagesId: listedProducts[index]?['users_customers_packages']?['packages_id'] !=
                                                                            _selectedPackageId
                                                                        ? null
                                                                        : listedProducts[index]?['users_customers_packages']
                                                                            ?[
                                                                            'users_customers_packages_id'],
                                                                  )),
                                                          (route) => false);
                              ...
                              } else if (listedProducts[index]['featured'] ==
                                  'Yes') {
                                ScaffoldMessenger.of(context).showSnackBar(
                                    ErrorSnackBar(
                                        message:
