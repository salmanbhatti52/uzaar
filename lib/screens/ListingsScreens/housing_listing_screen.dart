                      ...
                      itemBuilder: (context, index) {
                        return HousingListTile(
                          ...
                          houseImage: imgBaseUrl +
                              listedHousings[index]['listings_images'][0]
                                  ['image'],
                          ...
                          furnishedStatus:
                              listedHousings[index]['furnished'] == 'Yes'
                                  ? 'Furnished'
                                  : 'Not Furnished',
                          ...
                          onSelected: (selectedValue) async {
                            ...
                            if (selectedOption == 'boost') {
                              if (listedHousings[index]['featured'] == 'No') {
                                showDialog(
                                  context: context,
                                  builder: (
                                    context,
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (context) =>
                                                                  PaymentScreen(
                                                                    ...
                                                                    selectedPackage:
                                                                        selectedPackage,
                                                                    userCustomerPackagesId: listedHousings[index]?['users_customers_packages']?['packages_id'] !=
                                                                            _selectedPackageId
                                                                        ? null
                                                                        : listedHousings[index]?['users_customers_packages']
                                                                            ?[
                                                                            'users_customers_packages_id'],
                                                                  )),
                                                          (route) => false);
                              ...
                              } else if (listedHousings[index]['featured'] ==
                                  'Yes') {
                                ScaffoldMessenger.of(context).showSnackBar(
                                    ErrorSnackBar(
                                        message:
