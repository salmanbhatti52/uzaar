...
const Color d9d9d9 = Color(0xffD9D9D9);
const Color paypalHeaderBg = Color(0xFF003087);
...
final kFontTwelveThreeHG = GoogleFonts.outfit(
  fontSize: 12,
...
final kFontTwelveThreeHW = GoogleFonts.outfit(
  fontSize: 12,
  fontWeight: FontWeight.w300,
  color: white,
);
